...
use App\Availability\Application\Command\CancelBookingCommand;
...
final class CancelBookingCommandHandler implements CommandHandler
{
    ...
    public function __invoke(CancelBookingCommand $command): void
    {
        ...
        $availability->cancelBooking($command->count);
