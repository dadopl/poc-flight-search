...
use App\Availability\Application\Command\ReleaseSeatsCommand;
...
final class ReleaseSeatsCommandHandler implements CommandHandler
{
    ...
    public function __invoke(ReleaseSeatsCommand $command): void
    {
        ...
        $availability->releaseBlockedSeats($command->count);
